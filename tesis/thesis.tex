...
\title{Modelo de Predicción Secuencial de WebAccess Log basado en Algoritmo de Compresión y Machine Learning}
...
% Agradecimientos
%\acknowledgment{ \input{thanks-to} }

% Abstrat en inglés
\abstract{ \input{abstract-en} }

% Resumen
\resumen{ 	\input{abstract-es} }
...
\input{anexo} % Aca se incluyen los archivos con el texto de los anexos
