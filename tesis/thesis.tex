...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Dedicatoria
\dedicatory{Dedicado a mi hijo, mis padres, como también a todas las personas cercanas que no dejaron de apoyarme  y motivarme.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Agradecimientos
\acknowledgment{ \input{thanks-to} }
% Abstract en inglés
\abstract{ \input{abstracts/abstract-en} }
% Resumen - Abstract en español
\resumen{ 	\input{abstracts/abstract-es} }
%%%%%%%%%%%%%%%%%%%%%%%%%%%
