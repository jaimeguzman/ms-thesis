...
\newcommand{\predictionio}{\emph{PredictionIO}\xspace}
...
\newcommand{\footnotePublicRepo}{Repositorio público, \url{https://github.com/jaimeguzman/PredictionIO-LZmodel}}
...
% citas
% prefijos
% LDC un paper con relacion a compresion
