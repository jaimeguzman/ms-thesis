...
Donde $\sigma_{1}$, puede ser definido como la página inical de una cierta secuencia  ó sesión de usuario. Este alfabeto es finito y acotoda por una mineria de datos ya realizada por. % Referencia al trabajo de claud
