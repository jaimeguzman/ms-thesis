...
Los modelos comunmente usados en Compresión de datos son los siguiente:
...
El resultado final del modelamiento matemático en el contexto de la compresión, es un modelo factible, en el cual la redundancia de datos y ciertas restricciones de salida se intercectan en una relación definidad, tanto para la entrada del algoritmo como su salida.
...
Los algoritmos de compresión tienen como objetivo convertir datos de una fuente a una representación más comprimida, inversamente desde una representación comprimida a una fuente de datos incial. El primer proceso lo realiza un \emph{compresor de datos} y el segundo es un \emph{decodificador o decompresor de datos}. 
...
%  El dispositivo que se utiliza para cumplir la tarea de codificación se suele llamar codificador significa codificador. 
...
Los Algoritmos de compresión se clasifican en algoritmos sin pérdida de datos y con pérdida. Los algoritmos de compresión sin pérdida o  \losslessdatacompression(\LDC), se encuentran en nuestro día a día, por ejemplo en programas de escritorio o en el \emph{kernel Linux}. La motivación de profundizar en el área de compresión sin pérdida(\LDC), es la cantidad de posibilidades que entregan para mejorar ciertas operaciónes de manera más eficiente, por ejemplo la  transferencia de archivos en la web, que ayudan a transmistir información más rapidamente.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Megha Atwal, Lovnish Bansal Fast Lempel-ZIV (LZ’78) Algorithm Using Codebook Hashing
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
