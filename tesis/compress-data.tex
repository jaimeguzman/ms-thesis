...
% ~\cite{Begleiter2004}
% El algoritmo LZ78 es uno de los algoritmos de compresión sin pérdida más populares (Ziv y Lem- pel, 1978). Se utiliza como base de la utilidad de Unix comprimir y otras utilidades de archivado populares para PC.
...
% Observaciones sobre LZ78
	% 1. LZ78 ha hecho algunas mejoras sobre LZ77. 
	...
	% 2. Las palabras de código de salida contienen un componente 
	% menos que los de LZ77. Esto mejora la eficiencia de los datos.

	% 3. LZ78 tiene muchas variantes y LZW es la varianza más popular para LZ78, 
