\section[Conceptos básicos]{Conceptos básicos} \label{conceptos-basicos}


En esta sección se explicarán brevemente los conceptos principales que se usarán en los siguientes capítulos.

%En este cap ́ıtulo repasaremos brevemente conceptos elementales que el lector ya debiera conocer, y luego introduciremos elementos ma ́s relacionados con la materia. La mayor ́ıa de las definiciones, lemas, etc. de este cap ́ıtulo no est ́an indexados en el  ́Indice de Materias al final del apunte, pues son demasiado b ́asicos. Indexamos s ́olo lo que se refiere al tema espec ́ıfico de lenguajes formales, complejidad, y computabilidad.
