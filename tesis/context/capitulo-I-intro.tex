...
% - El internet ha evolucionado, no solo en comon se construye si no también como los usuarios se relacionan con los elementos de este.

% ============================


% En la actualidad los usuarios y clientes finales de muchos servicios que se ofrecen en Internet, poseen una característica común que es la interacción entre los usuarios y estos sistemas informáticos. Podemos tomar como ejemplos las paginas de redes sociales, comercios electrónicos o noticias.
