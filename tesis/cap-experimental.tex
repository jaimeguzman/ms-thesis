...
%	\addlegendentry{Nodes/train}
	...
	Congruento con lo anterior podemos ver que sin tener un margen de erro superior al split de datos seleccionado logramos un latencia de consulta predictiva en línea de alrededor de 70 \emph{seg}. el cual para ser implementado y consumido como ya se había mencionado antes como un algoritmo predictivo como servicio REST, esta dentro del promedio aceptable.
