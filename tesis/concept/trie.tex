...
Durante este trabajo mostraremos que nuestro modelo de predicción usa un \trie, para representar un diccionario generado por un algoritmo de compresión, en los cuales podemos señalar las siguientes operaciones disponibles que serán útiles conocer. Consideremos $x$ una cadena de caracteres
...
\begin{itemize}	
	...
	\item \textbf{contains(x):} Retorna una lista de nodos intermedios entre la raíz del \trie hasta el contenido del nodo sea hoja o intermedio que corresponda al valor de $x$.
