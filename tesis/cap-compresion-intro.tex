...
En el capitulo~\ref{capitulo-I} se ha planteado como ciertos algoritmos de compresión se pretenden usar como un predictor de secuencias discretas, para lograr entender como es realizarlo, se explicarán conceptos de compresión que darán los fundamentos para comprobar esta idea.
