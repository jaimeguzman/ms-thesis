...
\subsection{Cadenas Ocultas de Markov}

Las cadenas ocultas de Markov o en sus siglas en inglés HMM (Hidden Markov Model), son normalmente usados en reconocer discuros o lenguaje, reconocimiento de patrones en imágenes y video, traducción de textos, clasificaciónd de texto, etiquetado de documentos y también en compresión de datos.

% repetido
Una gran diferencia entre los modelos ocultos de markov y un proceso de markov clásico es que los primeros los estados no son observables. Un nueva observación es emitidad con una probabilidad conocida.

Un modelo oculto de Markov consiste en un proceso de Markov (también conocido como una cadena de Markov) para observaciones con un tiempo discreto. La principal diferencia con los procesos de Markov es que los estados no son observables. Una nueva observación se emite con una probabilidad conocida como la probabilidad de emisión cada vez que el estado del sistema o modelo cambios.
